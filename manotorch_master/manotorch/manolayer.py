...
manotorch_master_dir = os.path.dirname(current_dir)
if manotorch_master_dir not in sys.path:
    sys.path.append(manotorch_master_dir)
...
class ManoLayer(torch.nn.Module):
    ...
    def __init__(
        ...
        **kargs,
        ...
        mano_assets_path = os.path.join(manotorch_master_dir, "mano", "models", f"MANO_{side.upper()}.pkl")  # eg.  MANO_RIGHT.pkl
